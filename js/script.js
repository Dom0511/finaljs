...
function saveOrUpdateData() {
  ...
  if (saveBtn.innerText === "Save") {
      ...
      newRow.innerHTML = `
          ...
          <td>${dateTime}</td>
          <td>
              <button class="btn btn-primary editBtn" onclick="editData(this)">Edit</button>
              <button class="btn btn-danger deleteBtn" onclick="deleteData(this)">Delete</button>
          </td>
      `;
...
function loadData() {
  ...
  // Update row numbers after loading data
  updateRowNumbers();
}
